...
MAX_LLM_CHARS = int(os.getenv("MAX_LLM_CHARS", "10000"))  # Reduced from 18000 — menus rarely need more
...
# Vision configuration (gpt-4o-mini supports vision at ~10x lower cost than gpt-4o)
GPT52_VISION_ENABLED = os.getenv("GPT52_VISION_ENABLED", "true").lower() in ("1", "true", "yes")
GPT52_MODEL = os.getenv("GPT52_MODEL", "gpt-4o-mini")  # Changed from gpt-4o — same quality, ~10x cheaper
GPT52_MAX_PAGES = int(os.getenv("GPT52_MAX_PAGES", "2"))  # Reduced from 4 — first 2 pages cover 95%+ of menus
GPT52_MAX_IMAGE_WIDTH = int(os.getenv("GPT52_MAX_IMAGE_WIDTH", "1000"))  # Reduced from 1400 — fewer image tiles
