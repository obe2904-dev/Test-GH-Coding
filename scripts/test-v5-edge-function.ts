// Test NEW V5 Brand Profile Generator Edge Function
// Run: deno run --allow-net --allow-env --allow-read --env-file=.env scripts/test-v5-edge-function.ts
...
// Café Faust ID from businesses table
const testBusinessId = '840347de-9ba7-4275-8aa3-4553417fc2af';

console.log('🚀 Testing V5 Brand Profile Generator Edge Function\n');
...
try {
  ...
  console.log('\n📍 Next step: View results at http://localhost:3000/dashboard/brand');
