...
serve(async (req) => {
  ...
  try {
    ...
    const outdoorProhibitionBlock = !hasOutdoorSeating
      ? `\n🚫 FORBUDT I DAG: Forretningen HAR IKKE udeservering. Forslå ALDRIG udeservering, gårdhave eller udendørs-relaterede idéer. Fokusér kun på indendørs oplevelser.`
