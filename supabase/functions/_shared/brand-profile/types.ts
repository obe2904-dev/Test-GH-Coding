...
export interface DataSources {
  ...
  // Tier 1 writing samples (V2: moved from display-only to active generator input)
  // Fetched from business_brand_profile.sample_posts — highest-fidelity tone signal
  existingSamplePosts?: Array<{ post_text: string; why_this_works?: string }> | null
