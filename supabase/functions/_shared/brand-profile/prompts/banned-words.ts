/**
 * Banned Words - Smart filtering for AI-generated content
 *
 * Contains default banned word lists and utilities to filter out
 * words that the business uses on their own website (v4.8.9).
 * Moved from prompt-b.ts in v4.14.0.
 */
