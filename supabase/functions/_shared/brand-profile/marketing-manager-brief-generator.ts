...
function buildMarketingBriefPrompt(input: MarketingManagerBriefInput, language: string = 'da'): string {
  ...
  parts.push(`[NOTE: Voice profile (tone_rules, personality, formality) findes allerede separat i UI - gentag IKKE disse]`)
  parts.push(`[I stedet: Syntesér HVORDAN tone anvendes strategisk i forskellige situationer]`)
  parts.push(`[Eksempel: "Ved premium-retter brug elevated language + minimer emojis. Ved casual øjeblikke brug venlige fraser + ☀️"]`)
  parts.push(``)
  parts.push(`STRATEGI:`)
  ...
  parts.push(`5. DIN STEMME skal ALDRIG gentage tone rules fra voice profile - kun strategisk anvendelse`)
