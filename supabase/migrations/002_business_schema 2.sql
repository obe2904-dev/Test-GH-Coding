...
DROP POLICY IF EXISTS "Users can manage their business profile" ON public.business_profile;
...
DROP POLICY IF EXISTS "Users can manage their brand profile" ON public.business_brand_profile;
