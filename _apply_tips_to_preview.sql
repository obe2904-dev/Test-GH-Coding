-- ============================================================================
-- APPLY DASHBOARD TIPS TO PREVIEW DATABASE (kvqdkohdpvmdylqgujpn)
-- ============================================================================
-- This script combines both the initial migration and the hashtag accuracy updates
-- Run this in the Supabase SQL Editor for project kvqdkohdpvmdylqgujpn
-- Dashboard: https://supabase.com/dashboard/project/kvqdkohdpvmdylqgujpn
...
-- Insert tips (with corrected hashtag information)
INSERT INTO dashboard_tips (tip_da, tip_en, requires_verification, verification_notes) VALUES
(
  'På Facebook bruger vi 0–2 hashtags, på Instagram 3–5. Mere end det skader faktisk rækkevidden — det har vi styr på.',
  'On Facebook we use 0-2 hashtags, on Instagram 3-5. More than that actually hurts reach — we have that covered.',
  true,
  'Verify hashtag limits in caption generation logic'
),
(
  'På Facebook virker lokale hashtags bedst — fx #Silkeborg eller #SilkeborgMad. Systemet vælger dem automatisk ud fra jeres placering.',
  'On Facebook, local hashtags work best — e.g. #Silkeborg or #SilkeborgFood. The system chooses them automatically based on your location.',
  true,
  'Verify location-based hashtag generation for Facebook'
),
(
  'På Instagram blander vi niche, kategori og lokation i op til 5 hashtags — fx #KoreanFood #Sushi #Aarhus #Foodie. Det rammer dem, der faktisk leder efter jeres type mad.',
  'On Instagram we mix niche, category and location in up to 5 hashtags — e.g. #KoreanFood #Sushi #Aarhus #Foodie. This reaches people actually looking for your type of food.',
  true,
