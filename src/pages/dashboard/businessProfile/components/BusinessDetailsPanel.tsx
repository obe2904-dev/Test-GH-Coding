    ...
    return (
      <div className="text-center py-12" aria-live="polite">
        <div className="inline-flex items-center justify-center w-16 h-16 bg-indigo-100 rounded-full mb-4">
          <AnalyzeIcon className="w-8 h-8 text-indigo-600 animate-spin motion-reduce:animate-none" />
        </div>
        <h3 className="text-lg font-semibold text-gray-900 mb-2">
          {t('business.analyzing')}
        </h3>
        <p className="text-sm text-gray-600">{t('business.analysisFetching')}</p>
      </div>
    )
  }
  ...
  if (!analysisComplete) {
    return (
      <div className="text-center py-6">
        ...
        <h3 className="text-base font-semibold text-gray-900 mb-1">{t('business.enterWebsiteAbove')}</h3>
          <p className="text-xs text-gray-500">{t('business.aiAnalysisNote')}</p>
          <p className="text-xs text-gray-500">{t('business.changeLater')}</p>
      </div>
    )
  }
    ...
    <div className="space-y-4">
      <div className="mb-4">
        ...
        <div className="space-y-1">
          <p className="text-sm font-semibold text-gray-900">{t('business.reviewAndEdit')}</p>
          <p className="text-xs text-gray-600">{t('business.aiAnalysisNote')}</p>
          <p className="text-xs text-gray-500">{t('business.changeLater')}</p>
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-xs font-medium text-gray-700 mb-1">{t('business.basicInfo.businessName')}</label>
            <input
              type="text"
              value={businessName}
          ...
          <div>
            <label className="block text-xs font-medium text-gray-700 mb-1">{t('business.basicInfo.businessType')}</label>
            <select
