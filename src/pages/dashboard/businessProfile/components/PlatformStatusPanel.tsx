    ...
    <div>
      ...
      <div className="space-y-3">
        ...
        {isConnected('instagram') && (
          <div className="flex items-center justify-between p-3 border border-pink-200 bg-pink-50 rounded-lg">
            <div className="flex items-center gap-3">
        ...
        {!isConnected('facebook') && !isConnected('instagram') && (
          <div className="text-center py-4 text-gray-500">
            <p className="text-sm">Ingen platforme valgt endnu.</p>
            <p className="text-xs mt-1">Vælg platforme ovenfor for at se forbindelsesmuligheder her.</p>
          </div>
        )}
      </div>
    </div>
