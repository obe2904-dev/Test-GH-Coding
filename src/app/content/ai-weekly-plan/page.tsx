      ...
      posts: [
        {
          ...
          platformFormat: { platform: 'instagram', format: 'single_image', platformRationale: 'Primary platform', formatRationale: 'Single image' },
          ...
          visualDirection: { subject: 'Croissants', angle: 'overhead', setting: 'table', lighting: 'natural', styling: 'minimal', context: 'morning', technicalSpecs: { dimensions: '1080x1080', aspectRatio: '1:1', fileFormat: 'JPEG' }, altText: 'Fresh croissants' },
          productionNotes: { estimatedTime: '5-10 min', logistics: [] },
          alternatives: [{ priority: 1, description: 'Alternative dish' }],
        ...
        },
        {
          ...
          contentSubject: { dish: 'Frokostspecial: Laksesalat', whyThisDish: ['Lunch special'] },
          caption: { text: '', characterCount: 0, tone: 'friendly', emojiCount: 0, ctaType: 'booking', firstLine: '', isAIGenerated: true },
          visualDirection: { subject: 'Salmon salad', angle: 'overhead', setting: 'table', lighting: 'natural', styling: 'minimal', context: 'lunch', technicalSpecs: { dimensions: '1080x1080', aspectRatio: '1:1', fileFormat: 'JPEG' }, altText: 'Salmon salad' },
        ...
        {
          timing: { day: 'Friday', date: toISO(new Date(nextMonday.getFullYear(), nextMonday.getMonth(), nextMonday.getDate() + 4)), time: '17:00', rationale: 'Evening post' },
          platformFormat: { platform: 'instagram', format: 'single_image', platformRationale: 'Primary platform', formatRationale: 'Single image' },
          postType: { type: 'single_image', category: 'atmosphere', goal_mode: 'build_brand', priority: 'Medium', priorityReasons: ['Test post'] },
          contentSubject: { dish: 'Weekend stemning ved åen', whyThisDish: ['Weekend atmosphere'] },
          caption: { text: '', characterCount: 0, tone: 'friendly', emojiCount: 0, ctaType: 'engagement', firstLine: '', isAIGenerated: true },
          visualDirection: { subject: 'Atmosphere', angle: 'wide', setting: 'outdoor', lighting: 'natural', styling: 'ambient', context: 'weekend', technicalSpecs: { dimensions: '1080x1080', aspectRatio: '1:1', fileFormat: 'JPEG' }, altText: 'Weekend atmosphere' },
          productionNotes: { estimatedTime: '5 min', logistics: [] },
          alternatives: [{ priority: 1, description: 'Alternative scene' }],
          media: { status: 'pending', uploadedFiles: [] },
          approval: { status: 'draft', editHistory: [] },
          strategicContext: {},
        },
