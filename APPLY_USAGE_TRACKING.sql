-- Apply usage tracking migration directly
\c postgresql://postgres.kvqdkohdpvmdylqgujpn:Nordiclogistics11@aws-0-eu-central-1.pooler.supabase.com:6543/postgres
...
BEGIN
  ...
  SELECT 
    ...
    COUNT(*) FILTER (WHERE selected = TRUE)::INTEGER AS suggestions_selected,
...
BEGIN
  ...
  SET 
    ...
    selected = TRUE  -- Mark as selected when text is generated
